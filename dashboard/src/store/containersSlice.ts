...
export const createContainer = createAsyncThunk<
  ...
  { image: string; name?: string; ports?: Record<string, number>; env?: Record<string, string>; autoStart?: boolean; cpuLimit?: number; memoryLimit?: number; restartPolicy?: string; maxRetryCount?: number },
  { rejectValue: string }
>(
  'containers/create',
